...
export const PAGES_DATA: PagesData = {
    home: {
      meta: {
        title: "Oisans Expert IA | Solutions IA pour Entreprises Locales",
        description: "Découvrez nos solutions IA sur mesure pour les entreprises de l'Oisans et de toute la France : Répondeur IA, Chatbots, Automatisation, Sites Web et Formations."
      }
    },
    solutions: {
      ...
      meta: {
        title: "Solutions IA sur Mesure | Oisans Expert IA",
        description: "Explorez nos solutions d'intelligence artificielle : Répondeur intelligent, chatbot, automatisation de processus, création de sites web et formations IA pour professionnels."
      }
    },
    repondeur_ia: {
      ...
      meta: {
          title: "Répondeur IA Intelligent | Ne Manquez Plus Aucun Appel",
          description: "Notre Répondeur IA gère vos appels 24/7, qualifie les prospects, prend des rendez-vous et gère les urgences. Idéal pour les artisans, professions libérales et PME."
      }
    },
    chatbot_ia: {
      ...
      meta: {
          title: "Chatbot IA sur Mesure | Automatisez Votre Service Client",
          description: "Créez un chatbot intelligent pour votre site web, Messenger ou WhatsApp. Répondez aux questions 24/7, générez des leads et améliorez l'expérience client."
      }
    },
    automatisation_ia: {
      ...
      meta: {
          title: "Automatisation des Processus avec l'IA | Gagnez en Productivité",
          description: "Libérez-vous des tâches répétitives. Nous connectons vos outils et automatisons vos workflows pour plus d'efficacité et moins d'erreurs. Contactez-nous pour un audit."
      }
    },
    sites_internet: {
      title: "Création de sites internet",
      ...
      cta: { label: "Lancer mon site", href: "/contact" },
       meta: {
          title: "Création de Sites Internet Modernes et Performants | Oisans Expert IA",
          description: "Nous créons des sites web rapides, optimisés pour le SEO local et prêts à intégrer nos solutions IA (chatbot, formulaires intelligents). Obtenez votre devis."
      }
    },
    formations_ia: {
      title: "Formations IA",
      ...
      meta: {
          title: "Formations IA pour Entreprises | Maîtrisez les Outils de Demain",
          description: "Nos formations IA sur mesure (ChatGPT, automatisation) sont conçues pour les professionnels. Apprenez à intégrer l'IA dans votre quotidien pour gagner en productivité."
      }
    },
    formation_programs: [
      {
    ...
    a_propos: {
      ...
      content: [
       ...
       meta: {
          title: "À Propos de Oisans Expert IA | Votre Partenaire IA Local",
          description: "Découvrez l'histoire et les valeurs d'Oisans Expert IA, votre partenaire de confiance pour l'intégration de l'intelligence artificielle au cœur des Alpes et partout en France."
      }
    },
    contact: {
      title: "Contact",
      ...
      meta: {
          title: "Contactez Oisans Expert IA | Devis Gratuit",
          description: "Contactez-nous pour discuter de votre projet IA. Remplissez notre formulaire pour obtenir un devis gratuit et personnalisé sous 48h pour votre répondeur, chatbot ou projet d'automatisation."
      }
    },
    etudes_de_cas: {
        meta: {
            title: "Études de Cas IA | Projets Clients Réussis",
            description: "Découvrez comment nous avons aidé des entreprises comme la vôtre à résoudre leurs défis grâce à nos solutions IA sur mesure. Résultats concrets et témoignages clients."
        }
    },
    blog: {
        meta: {
            title: "Blog & Analyses IA | Oisans Expert IA",
            description: "Restez à la pointe de l'intelligence artificielle. Notre blog décrypte les tendances, partage des conseils pratiques et vous aide à comprendre l'impact de l'IA sur votre entreprise."
        }
    },
    outils: {
        meta: {
            title: "Outils IA Gratuits | Oisans Expert IA",
            description: "Testez la puissance de l'IA avec nos outils gratuits. Générez des noms d'entreprise, des idées de contenu et plus encore, directement depuis notre site."
        }
    },
    not_found: {
        meta: {
            title: "404 - Page non trouvée | Oisans Expert IA",
            description: "La page que vous recherchez n'a pas pu être trouvée. Retournez à l'accueil pour découvrir nos solutions d'intelligence artificielle."
        }
    }
};
