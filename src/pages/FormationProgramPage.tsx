...
const FormationProgramPage: React.FC = () => {
    ...
    const schema = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Formations IA",
          "item": "https://www.oisans-expert-ia.fr/#/formations-ia"
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Programmes Détaillés",
          "item": "https://www.oisans-expert-ia.fr/#/formations-ia/programme"
        }
      ]
    };
    ...
    return (
        <div className="bg-white">
            <SeoMeta 
                title="Programmes de Formation IA Détaillés | Oisans Expert IA"
                description="Découvrez le contenu détaillé de nos formations IA : Découverte, Avancée et Expert. Des modules pratiques pour maîtriser l'IA de A à Z."
                canonical="https://www.oisans-expert-ia.fr/#/formations-ia/programme"
                schema={schema}
            />
